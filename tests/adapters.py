...
def run_linear(
    ...
    linear_module = LinearModule(d_in, d_out)
    state_dict = {
        "weight": weights,
    }
...
def run_embedding(
    ...
    embedding_module = EmbeddingModule(vocab_size, d_model)
    state_dict = {
        "weight": weights,
    }
...
def run_multihead_self_attention(
    ...
    multihead_attention.wqkv.weight.data = combined_weight
    multihead_attention.output_proj.weight.data = o_proj_weight
    multihead_attention.o_proj_weight = o_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    multihead_attention.wqkv.weight.data = combined_weight
    multihead_attention.output_proj.weight.data = o_proj_weight
    return multihead_attention(in_features, RoPE(theta, d_model // num_heads, max_seq_len))
...
def run_get_batch(
    ...
    """
    return next(get_batch_data(dataset, batch_size, context_length, device))
...
def run_get_lr_cosine_schedule(
    ...
    """
    return learning_rate_cosine_scheduler(it, warmup_iters, cosine_cycle_iters, max_learning_rate, min_learning_rate)
